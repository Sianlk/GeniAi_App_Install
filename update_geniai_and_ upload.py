...
# === CONFIG SECTION ===
local_project_folder = './GeniAiOS'  # <-- Local folder after rename
mega_folder_name = 'GeniAiOS'        # <-- Mega.nz folder name
...
if __name__ == "__main__":
    print("\n=== Step 1: Replacing GenesisOS in Local Files ===")
