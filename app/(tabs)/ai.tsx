...
export default function AIScreen() {
  ...
  const [taskType, setTaskType] = useState('AI Orchestrator');
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.subtitle}>Domain: AI platform</Text>

      <Card variant="ai" style={styles.card}>
        <Text style={styles.label}>Task Type</Text>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.tagRow}>
          {['AI Orchestrator','Agent Workforce','Multi-Modal AI','Knowledge Base','AI Automation'].map((f) => (
            <TouchableOpacity
              key={f}
