      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.card}>
          <View style={styles.row}>
            ...
            <Text style={styles.dimText}>1.0.0</Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.rowLabel}>App</Text>
            <Text style={styles.dimText}>GeniAI</Text>
          </View>
        </View>
        ...
        <View style={styles.card}>
          <TouchableOpacity
            ...
            onPress={() => Linking.openURL('https://sianlk.com/privacy')}
          >
            <Text style={styles.link}>Privacy Policy</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.linkRow}
            onPress={() => Linking.openURL('https://sianlk.com/terms')}
          >
            <Text style={styles.link}>Terms of Service</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.linkRow}
            onPress={() => Linking.openURL('mailto:support@sianlk.com')}
          >
