...
const styles = StyleSheet.create({
  ...
  // Variants
  variant_primary:   { backgroundColor: '#8B5CF6' },
  variant_secondary: { backgroundColor: '#A78BFA33' },
  variant_outline:   { backgroundColor: 'transparent', borderWidth: 1.5, borderColor: '#8B5CF6' },
  variant_ghost:     { backgroundColor: 'transparent' },
  variant_danger:    { backgroundColor: Colors.error },
  variant_ai:        { backgroundColor: '#7C3AED', borderWidth: 1, borderColor: '#A78BFA' },

  // Labels
  label: { ...Typography.button },
  label_primary:   { color: '#FFFFFF' },
  label_secondary: { color: '#7C3AED' },
  label_outline:   { color: '#8B5CF6' },
  label_ghost:     { color: '#8B5CF6' },
