...
const ACTIONS = [
  { id: '1', title: 'AI Orchestrator', icon: 'sparkles-outline' },
  { id: '2', title: 'Agent Workforce', icon: 'sparkles-outline' },
  { id: '3', title: 'Multi-Modal AI', icon: 'sparkles-outline' },
  { id: '4', title: 'Knowledge Base', icon: 'sparkles-outline' },
  { id: '5', title: 'AI Automation', icon: 'sparkles-outline' },
];
