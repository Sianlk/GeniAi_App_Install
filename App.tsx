...
function App(): React.JSX.Element {
  ...
  const onPress = () => {
    Animated.sequence([
      ...
      setReady(true);
      Alert.alert('GeniAI', 'Welcome! App is running successfully.');
    });
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={styles.hero}>
          ...
          <Text style={styles.title}>GeniAI</Text>
          <Text style={styles.tagline}>The Complete AI Operating System</Text>
