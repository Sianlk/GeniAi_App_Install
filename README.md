...
<img src="assets/graphics/icon-1024.svg" width="120" alt="GeniAI Icon" />

# GeniAI

### Genius in Your Pocket

[![CI](https://github.com/Sianlk/GeniAi_App_Install/actions/workflows/backend-ci.yml/badge.svg)](https://github.com/Sianlk/GeniAi_App_Install/actions/workflows/backend-ci.yml)
[![Security Scan](https://github.com/Sianlk/GeniAi_App_Install/actions/workflows/security-scan.yml/badge.svg)](https://github.com/Sianlk/GeniAi_App_Install/actions/workflows/security-scan.yml)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
[![Platform](https://img.shields.io/badge/platform-iOS%20|%20Android-lightgrey.svg)](https://geniai.app)
[![FastAPI](https://img.shields.io/badge/backend-FastAPI-009688.svg)](https://fastapi.tiangolo.com)
[![React Native](https://img.shields.io/badge/mobile-React%20Native-61DAFB.svg)](https://reactnative.dev)

**AI platform, productivity, mobile**

[Website](https://geniai.app) · [Privacy Policy](https://geniai.app/privacy) · [Support](https://geniai.app/support)
...
- **AI-Powered Core** — Intelligent automation and recommendations tailored to AI platform
