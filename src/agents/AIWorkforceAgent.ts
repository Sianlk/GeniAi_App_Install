// AI Workforce Agent — GeniAI
// Autonomous AI worker for AI platform
...
// Specialised AI agents for AI platform
const AGENT_PERSONAS = {
  analyst: {
    name: 'GeniAI Analyst',
    role: `Expert AI platform analyst with deep knowledge of multi-modal AI, GPT orchestration, autonomous agents, AI workforce.`,
    capabilities: ["AI Orchestrator", "Agent Workforce", "Multi-Modal AI", "Knowledge Base", "AI Automation"],
  },
  advisor: {
    name: 'GeniAI Advisor',
    role: `Senior AI platform advisor providing strategic recommendations.`,
    capabilities: ['Strategic planning', 'Risk assessment', 'Optimization'],
  },
  automator: {
    name: 'GeniAI Automator',
    role: `Autonomous AI platform task executor and workflow manager.`,
