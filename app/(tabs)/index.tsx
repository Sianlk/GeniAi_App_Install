...
const QUICK_ACTIONS = [
        { id: '1', title: 'AI Orchestrator', icon: 'sparkles-outline', color: Colors.primary },
        { id: '2', title: 'Agent Workforce', icon: 'sparkles-outline', color: Colors.primary },
        { id: '3', title: 'Multi-Modal AI', icon: 'sparkles-outline', color: Colors.primary },
        { id: '4', title: 'Knowledge Base', icon: 'sparkles-outline', color: Colors.primary },
        { id: '5', title: 'AI Automation', icon: 'sparkles-outline', color: Colors.primary },
];
...
export default function HomeScreen() {
  ...
  async function handleAIQuery() {
    ...
    setLoading(true);
    Analytics.aiQuery(prompt, 'AI platform');
    try {
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.tagline}>Your full-stack AI platform</Text>
        </View>
      ...
      <Card variant="ai" style={styles.aiCard}>
        <View style={styles.aiBadge}>
          ...
          <Text style={styles.aiBadgeText}>AI — AI platform</Text>
        </View>
        <TextInput
