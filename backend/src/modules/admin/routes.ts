...
export async function adminRoutes(app: FastifyInstance) {
  ...
  app.post(
    '/api/admin/workforce/:id/request-approval',
    { preHandler: [requireAdminOrSuper] },
    async (req, reply) => {
      ...
      const { signature, timestamp } = generateApprovalSignature(
        actor.email,
        id,
  ...
  app.post(
    '/api/admin/workforce/:id/approve',
